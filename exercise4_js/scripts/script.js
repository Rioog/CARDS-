...
const cards = [
  ...
  {
    image: "https://images.pexels.com/photos/3779187/pexels-photo-3779187.jpeg",
    name: "Seúl",
  },
  {
...
// Recorre el arreglo y genera tarjetas
cards.forEach((card) => {
  createCard(card);
});
